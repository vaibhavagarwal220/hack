...
#logins{display:none;background-color:white;}
#logups{display:none;background-color:white;}
        ...
        <div class="container ">
            <div class="row">
                <div class="col-md-12 col-sm-12 animate fadeInDown">
                   <h1 class="text-capitalize">Welcome on <strong>Data<span class="themecolor">Bucks</span></strong></h1>
               <p class="lead">One for all<strong>,all for one</strong></p>
         <a class="btn btn-primary" id=logbtn><span class="glyphicon glyphicon-user"></span> Log In</a>
         <a class="btn btn-primary" id=signbtn><span class="glyphicon glyphicon-user"></span> Sign Up</a>
          ...
          <form method="post" action="<?php echo $current_file;?>" id=logins>
                ...
                <br>
                <label for="rmmbr">Remember Me<input type="checkbox" name=rmmbr id="rmmbr"></label><br>
                <input type="submit" value="Log In" class="btn btn-primary black-background">
                  </form>



<form method="post" action="<?php echo $current_file;?>" enctype="multipart/form-data" id="logups"><input type="file" id="file" accept='image/*' name="proim" >
